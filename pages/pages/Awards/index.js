...
import { Awards } from "../../../demo/service/Awards";
const Award = () => {
  let emptyProduct = {
    id: null,
    name: "",
  ...
  const [products, setAwards] = useState(null);
  const [productDialog, setAwardDialog] = useState(false);
  ...
  useEffect(() => {
    Awards.getAwards().then((data) => setAwards(data));
  }, []);
        ...
        <div className="card">
          ...
          >
            <div className="flex align-items-center justify-content-center">
              ...
              {product && (
                <span>
                  Are you sure you want to delete the selected Awards?
                </span>
              )}
            </div>
          </Dialog>
